...
export default Ember.Controller.extend({
    actions: {
        ...
        deleteDataPerimeter(id)
        {
              this.store.findRecord('perimeter', id).then(perimeter => {
                  perimeter.destroyRecord();
              });
        },
        ...
        editDataPerimeterUnit(data)
        {
            // Find the area
            this.store.findRecord('perimeter', data.id).then(perimeter => {
                perimeter.set("unit", data.unit);
                perimeter.save();
            });
        },
        ...
        {
            this.store.findAll('perimeter').then(perimeter => {
                perimeter.toArray().forEach(perimeter => {
                    perimeter.destroyRecord();
                });
            });
        }
